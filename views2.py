...
def login():
    ...
    return redirect(f'https://mis-api.cmu.ac.th/oauth/authorize?response_type=code&client_id={client_id}&redirect_uri={redirect_uri}')
...
def callback():
    ...
    app.logger.debug(f'Token Response: {token_response.status_code} {token_response.text}')
